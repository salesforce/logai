...
class SemanticVectorizerParams(Config):
    ...
    :param max_token_len: int = 10 : maximum token length of the input
    :param min_token_count: int = 1 : minimum count of occurrences of a token in training data for it to be considered in the vocab
    :param sep_token: str = "[SEP]" : separator token used to separate log lines in input log sequence
    :param embedding_dim: int = 300 : embedding dimension of the learnt token embeddings
    :param window: int = 3 : window size parameter for word2vec and fastText models
    :param embedding_type: str = "fasttext" : type of embedding, currently supports glove, word2vec and fastText
    :param model_save_dir: str = None : path to directory where vectorizer models would be saved
    """
...
class Semantic(VectorizationAlgo):
    ...
    :param params: (SemanticVectorizerParams): config object for semantic vectorizer
    """
