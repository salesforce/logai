...
class ForcastBasedNeuralAD(NNAnomalyDetectionAlgo):
    ...
    def __init__(self, config: ForecastBasedNNParams):
        """Initialization for forecasting based neural anomaly detection models.

        :param config: The config for general forecasting based neural anomaly detection models.
        """
        self.model = None
        self.config = config
...
class ForecastBasedTransformer(ForcastBasedNeuralAD):
    ...
    def __init__(self, config: TransformerParams):
        ...
        :param config: A config object containing parameters for
