...
class OpenSetPartitioner:
    def __init__(self, config: OpenSetPartitionerConfig):
        ...
        :param config: A config object specifying
    ...
    def generate_sliding_window(self, logrecord):
        ...
        :param logrecord: A logrecord object to be partitioned into sliding windows.
        :return: A LogRecordObject object where the body of logrecord object contains the generated
            log sequences.
        """
    ...
    def generate_session_window(self, logrecord):
        ...
        :param logrecord: A logrecord object to be partitioned into session windows.
        :return: A LogRecordObject object where the body of logrecord object contains the generated
            log sequences.
        """
    ...
    def partition(self, logrecord):
        ...
        :param logrecord: A logrecord object to be partitioned into session or sliding windows.
        :return: A LogRecordObject object where the body of logrecord object contains the generated
            log sequences.
        """
