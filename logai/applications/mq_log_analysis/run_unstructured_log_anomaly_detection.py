...
import os
import pandas as pd
from logai.applications.mq_log_analysis.unstructured_logs.logAD import (
    UnstructuredLogAnomalyDetection,
)
...
if __name__ == "__main__":
    ...
    stats_per_msgtype = unstructlogAD.unstructured_log_anomaly_detection(
